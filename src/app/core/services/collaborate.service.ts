...
private readonly options: CollaborateOption[] = [
  {
    ...
    title: 'Hazte socia',
    description:
      'Muestra tu compromiso con la lactancia materna vinculándote a Amamanta. Cuantas más socias forman parte de la asociación, mayor fuerza tiene para defender la lactancia materna de manera independiente.',
    extraInfo: [
      'Alta de socia: 30 €',
      'Renovación anual: 25 €'
    ],
    buttonText: 'Acceder al formulario oficial',
